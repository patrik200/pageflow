...
function ThirdBlock() {
  return (
    <BlockWrapper>
      ...
      <Point>Вносить изменения и дополнения в ПО «Пейджфлоу» с целью улучшения его работы;</Point>
      <Point>
        Прекратить предоставление возможности использовать ПО «Пейджфлоу» при нарушении Пользователем условий настоящего
        Соглашения;
      </Point>
      <Point>
        Без объяснения причины отказать Пользователю в приобретении права использования ПО «Пейджфлоу», заключении с
      ...
      <Point>Предоставлять Пользователю круглосуточный доступ к использованию функций ПО «Пейджфлоу»;</Point>
      <Point>
        Оказывать Пользователю поддержку по всем вопросам, касающимся функционирования ПО «Пейджфлоу», на условиях,
