...
interface DocumentRevisionUserFlowDeadlineAppearedInterface {
  frontendHost: string;
  number: string;
  id: string;
  deadlineAt: string;
...
function DocumentRevisionUserFlowDeadlineAppeared({
  frontendHost,
  number,
  id,
  deadlineAt,
}: DocumentRevisionUserFlowDeadlineAppearedInterface) {
    ...
    <Wrapper maxWidth="768px" frontendHost={frontendHost}>
      <div className={wrapperStyles}>
        ...
        <div className={bodyWrapperStyles}>
          <div className={titleTextStyles}>Крайний срок утверждения маршрута документа прошел</div>
...
export default React.memo(DocumentRevisionUserFlowDeadlineAppeared);
