...
interface CorrespondenceUpdatedInterface {
  frontendHost: string;
  name: string;
  id: string;
  updatedAt: string;
...
function CorrespondenceUpdated({ frontendHost, name, id, updatedAt }: CorrespondenceUpdatedInterface) {
    ...
    <Wrapper maxWidth="768px" frontendHost={frontendHost}>
      <div className={wrapperStyles}>
        ...
        <div className={bodyWrapperStyles}>
          <div className={titleTextStyles}>Корреспонденция обновлена</div>
...
export default React.memo(CorrespondenceUpdated);
