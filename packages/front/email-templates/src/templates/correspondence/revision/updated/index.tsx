...
interface CorrespondenceRevisionUpdatedInterface {
  frontendHost: string;
  number: string;
  id: string;
  updatedAt: string;
...
function CorrespondenceRevisionUpdated({
  frontendHost,
  number,
  id,
  updatedAt,
}: CorrespondenceRevisionUpdatedInterface) {
    ...
    <Wrapper maxWidth="768px" frontendHost={frontendHost}>
      <div className={wrapperStyles}>
        ...
        <div className={bodyWrapperStyles}>
          <div className={titleTextStyles}>Ревизия корреспонденции обновлена</div>
...
export default React.memo(CorrespondenceRevisionUpdated);
