...
interface TicketCreatedInterface {
  frontendHost: string;
  name: string;
  id: string;
  authorName: string;
...
function TicketCreated({ frontendHost, name, id, authorName, createdAt }: TicketCreatedInterface) {
    ...
    <Wrapper maxWidth="768px" frontendHost={frontendHost}>
      <div className={wrapperStyles}>
        ...
        <div className={bodyWrapperStyles}>
          <div className={titleTextStyles}>Создан новый запрос</div>
...
export default React.memo(TicketCreated);
