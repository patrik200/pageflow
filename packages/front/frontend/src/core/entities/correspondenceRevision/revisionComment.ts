...
export class CorrespondenceRevisionCommentEntity extends BaseEntity {
  constructor() {
    super();
    this.initEntity();
  }
...
export const arrayOfCorrespondenceRevisionCommentEntitiesDecoder = arrayOfEntitiesDecoder(
